...
public class DrawPrintTextLocations extends PDFTextStripper
{
    ...
    public static void main(String[] args) throws IOException
    {
       ...
       // {
            ...
            try
            {
                System.out.println("Bat dau xu ly file PDF");
                document = PDDocument.load(new File("D:\\Java_Project\\PDF_TEXT\\Vehinh\\10.1.1.193.1808_3.pdf"));
                DrawPrintTextLocations stripper = new DrawPrintTextLocations(document, "D:\\Java_Project\\PDF_TEXT\\Vehinh\\10.1.1.193.1808_3.pdf");
                stripper.setSortByPosition(true);
                for (int page = 0; page < document.getNumberOfPages(); ++page)
                {
                    stripper.stripPage(page);
                }
                System.out.println("Xu ly file PDF hoan thanh");
            }
            finally
            {
                if (document != null)
    ...
    protected void showGlyph(Matrix textRenderingMatrix, PDFont font, int code, String unicode, Vector displacement) throws IOException
    {
        ...
        System.out.print(textRenderingMatrix.toString());
        ...
        //if (cyanShape != null&&(textRenderingMatrix.get))
        //if (cyanShape != null&&font.getName().contains("TimesNewRoman")&&(unicode.equals("L")))
        if (cyanShape != null&&(unicode.equals("L")))
        {
            ...
            g2d.draw(cyanShape);
            rect= new Rectangle(cyanShape.getBounds());
        }
    }
    ...
    {
        System.err.println("Usage: java " + DrawPrintTextLocations.class.getName() + " D:\\Java_Project\\PDF_TEXT\\Vehinh\\Vidu.pdf");
    }
}
